                                        ...
                                        <div class="shopping_cart">
                                            ...
                                            <div class="cart_box1">
                                                <div class="message1">
                                                    ...
                                                    <div class="list_img"><img src="${pageContext.request.contextPath}/resources/pages/images/15.jpg" class="img-responsive" alt=""></div>
                                                    <div class="list_desc"><h4><a href="#">velit esse molestie</a></h4>1 x<span class="actual">
                                                            $12.00</span></div>
                                                    <div class="clearfix"></div>
                                                </div>
                    ...
                    <div class="h_menu4">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="${pageContext.request.contextPath}/shop.html">Shop</a>
                                <ul class="drop">
                                    <li><a href="${pageContext.request.contextPath}/category.html">Sony(2)</a></li>
